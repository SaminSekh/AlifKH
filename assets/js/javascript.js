...
function setupEventListeners() {
    ...
    document.querySelectorAll('.nav-sidebar ul li a').forEach(link => {
        ...
        const menuItems = [
            ...
            { id: 44, name: "Beef Khichuri", category: "mealspackage", price: 5, originalPrice: 7, discount: 29, description: "Spiced rice and lentils cooked together with vegetables or meat. Comforting and hearty, garnished with fried onions or ghee.", image: "https://raw.githubusercontent.com/SaminSekh/AlifKH/main/alifimage/hq720%20(1).jpg" },
            { id: 45, name: "Beef Biryani", category: "mealspackage", price: 5, originalPrice: 7, discount: 29, description: "Fragrant rice layered with spiced beef and saffron. A festive biryani served with raita or salad.", image: "https://raw.githubusercontent.com/SaminSekh/AlifKH/main/alifimage/Beef-Biryani-Rida-Aftab.jpg" },
            { id: 46, name: "Mutton Biryani", category: "mealspackage", price: 6, originalPrice: 7.5, discount: 20, description: "Aromatic mutton biryani with caramelized onions and rich spices. A luxurious celebratory dish.", image: "https://raw.githubusercontent.com/SaminSekh/AlifKH/main/alifimage/Best-Mutton-Biryani-Recipe.jpg" },
            { id: 47, name: "Chicken Biryani", category: "mealspackage", price: 4, originalPrice: 6, discount: 33, description: "Chicken biryani layered with fragrant rice and marinated chicken. Loved for its rich aroma and bold flavor.", image: "https://raw.githubusercontent.com/SaminSekh/AlifKH/main/alifimage/d815e816-4664-472e-990b-d880be41499f%20-%20chicken-biryani-recipe.jpg" },
            { id: 48, name: "Rice+Fish+Veg+Dal", category: "mealspackage", price: 4, originalPrice: 7, discount: 43, description: "Steamed white rice served with spiced fish curry, seasonal vegetables, and comforting red lentil dal. A balanced Bangladeshi meal offering mild heat and rich, homely flavors.", image: "https://raw.githubusercontent.com/SaminSekh/AlifKH/main/alifimage/Rice%2BFish%2BVeg%2BDal.jpeg" },
            { id: 49, name: "Rice+Beef+Veg+Dal", category: "mealspackage", price: 4, originalPrice: 6, discount: 33, description: "Fluffy rice paired with slow-cooked beef curry, fresh vegetables, and hearty lentil dal. A filling, protein-rich platter with deep, aromatic spices.", image: "https://raw.githubusercontent.com/SaminSekh/AlifKH/main/alifimage/Rice%2BBeef%2BVeg%2BDal.png" },
            { id: 50, name: "Rice+Mutton+Veg+Dal", category: "mealspackage", price: 5, originalPrice: 7, discount: 29, description: "Steamed rice served with tender mutton curry, mixed vegetables, and flavorful lentil dal. A classic, festive Bangladeshi combination full of rich, savory taste.", image: "https://raw.githubusercontent.com/SaminSekh/AlifKH/main/alifimage/Rice%20%2B%20Mutton%20%2B%20Veg%2B%20Dal.webp" },
            { id: 51, name: "Rice+Chicken+Veg+Dal", category: "mealspackage", price: 3.5, originalPrice: 5, discount: 30, description: "Soft white rice, spiced chicken curry, seasonal vegetables, and lentil dal - free home delivery at sihanoukville.", image: "https://raw.githubusercontent.com/SaminSekh/AlifKH/main/alifimage/Rice%2BChicken%2BVeg%2BDal.jpeg" },
            { id: 54, name: "Mango (1KG)", category: "fruits", price: 1.2, originalPrice: 1.5, discount: 20, description: "", image: "https://raw.githubusercontent.com/SaminSekh/AlifKH/main/alifimage/p06hk0h6.jpg" },
            { id: 57, name: "Grape (1KG)", category: "fruits", price: 3, originalPrice: 5, discount: 40, description: "2", image: "https://raw.githubusercontent.com/SaminSekh/AlifKH/main/alifimage/Grape%20(1%20KG).jpg" },
            { id: 58, name: "Banana (1KG)", category: "fruits", price: 1.5, originalPrice: 3, discount: 50, description: "", image: "https://raw.githubusercontent.com/SaminSekh/AlifKH/main/alifimage/NORMALLLL.jpg" },
            { id: 62, name: "avocado fruit (1KG)", category: "fruits", price: 1.5, originalPrice: 3, discount: 50, description: "", image: "https://www.secretosdelsur.com/wp-content/uploads/2021/07/aguacate-3-831x554.jpg" },
            { id: 71, name: "Mango milak shake Juice", category: "drinks", price: 1.5, originalPrice: 3, discount: 50, description: "Sweet, thick mango juice blended from ripe mangoes – loved by Indian tourists in Sihanoukville.", image: "https://raw.githubusercontent.com/SaminSekh/AlifKH/main/alifimage/10-benefits-of-mango-juice-3.jpg" },
            { id: 74, name: "Grape Juice", category: "drinks", price: 2, originalPrice: 4, discount: 50, description: "Sweet, slightly tart grape juice, served chilled for a rich fruity taste.", image: "https://raw.githubusercontent.com/SaminSekh/AlifKH/main/alifimage/Grape%20Juice.webp" },
            { id: 76, name: "Banana milk shake Juice", category: "drinks", price: 2, originalPrice: 3, discount: 33, description: "Creamy banana smoothie made with milk or yogurt, sweetened with honey or sugar.", image: "https://raw.githubusercontent.com/SaminSekh/AlifKH/main/alifimage/Banana%20Juice.jpeg" },
            { id: 79, name: "Coconut watter", category: "drinks", price: 1.25, originalPrice: 2, discount: 38, description: "Refreshing natural coconut water, full of electrolytes and hydrating goodness.", image: "https://raw.githubusercontent.com/SaminSekh/AlifKH/main/alifimage/shutterstock_490174816.jpg" },
            { id: 80, name: "Avocado milk shake Juice", category: "drinks", price: 2, originalPrice: 3.5, discount: 43, description: "Creamy avocado juice blended with milk or sugar, sometimes drizzled with honey.", image: "https://raw.githubusercontent.com/SaminSekh/AlifKH/main/alifimage/Avocado%20Juice.webp" },
            { id: 82, name: "Mixed Fruit Juice", category: "drinks", price: 2, originalPrice: 3.5, discount: 43, description: "Mixed fruit juice made from seasonal fruits like mango, pineapple, or banana, served chilled.", image: "https://raw.githubusercontent.com/SaminSekh/AlifKH/main/alifimage/Mixed-Fruits.jpg" },
            { id: 83, name: "Sweet Lassi", category: "drinks", price: 1.25, originalPrice: 3.5, discount: 64, description: "Traditional lassi made from yogurt and sugar – a cooling drink for halal food Sihanoukville meals.", image: "https://raw.githubusercontent.com/SaminSekh/AlifKH/main/alifimage/sweet-lassi-recipe-featured.jpg" },
            { id: 84, name: "Black Coffee", category: "drinks", price: 0.75, originalPrice: 1.8, discount: 58, description: "Strong, unsweetened black coffee brewed from roasted beans, served hot or cold.", image: "https://raw.githubusercontent.com/SaminSekh/AlifKH/main/alifimage/alin-luna-t4bpI1lXVH0-unsplash-scaled.jpg" },
            { id: 85, name: "Hot Coffee", category: "drinks", price: 0.75, originalPrice: 1.8, discount: 58, description: "Coffee with milk and sugar, served steaming hot for a comforting drink.", image: "https://raw.githubusercontent.com/SaminSekh/AlifKH/main/alifimage/istockphoto-509141291-612x612.jpg" },
            { id: 86, name: "Cold Coffee", category: "drinks", price: 0.75, originalPrice: 1.8, discount: 58, description: "Chilled coffee blended with milk, sugar, and ice cream for a creamy treat.", image: "https://raw.githubusercontent.com/SaminSekh/AlifKH/main/alifimage/Mocha-Iced-Coffee-with-Vanilla-Cold-Foam-800x550-1.jpg" },
            { id: 87, name: "Black Coffee Premium", category: "drinks", price: 1.5, originalPrice: 3, discount: 50, description: "Premium black coffee brewed for bold flavor, served hot or iced.", image: "https://raw.githubusercontent.com/SaminSekh/AlifKH/main/alifimage/Black%20Coffee%20Premium.png" },
            { id: 88, name: "Hot Coffee Premium", category: "drinks", price: 1.5, originalPrice: 3, discount: 50, description: "Premium coffee blended with milk and sugar for a smooth, rich taste.", image: "https://raw.githubusercontent.com/SaminSekh/AlifKH/main/alifimage/cup-of-black-coffee-scaled-720x540.jpeg" },
            { id: 89, name: "Cold Coffee Premium", category: "drinks", price: 1.5, originalPrice: 3, discount: 50, description: "Chilled coffee with premium beans, milk, and ice cream for a luxurious drink.", image: "https://raw.githubusercontent.com/SaminSekh/AlifKH/main/alifimage/cold-coffee.jpg" },
            { id: 90, name: "Dudh Cha (1 Cup) ", category: "drinks", price: 0.9, originalPrice: 1, discount: 10, description: "Milky chai brewed with tea, sugar, and cardamom at bangladeshi resturant in sihanoukville.", image: "https://raw.githubusercontent.com/SaminSekh/AlifKH/main/alifimage/41093853795_47e4cd703b_b.jpg" },
            { id: 91, name: "Rong Cha (1 Cup)", category: "drinks", price: 0.5, originalPrice: 1, discount: 50, description: "Plain black tea brewed without milk, lightly sweetened or unsweetened at alifkh resturant sihanoukville.", image: "https://raw.githubusercontent.com/SaminSekh/AlifKH/main/alifimage/rong-cha.jpg" },
